...
const CollegeLogin=()=>{
    ...
    const collectiondata = (e) => {
        ...
        axios
            ...
            .then((result) => {
                ...
                if (result.data.auth) {
                    localStorage.setItem("institute", JSON.stringify(result.data.user));
    ...
    return (
        <div>
            ...
            {/* <h2 className="text-3xl bg-gradient-to-r from-orange-500 to-red-800 text-transparent bg-clip-text"> Institute Login Window</h2> */}
