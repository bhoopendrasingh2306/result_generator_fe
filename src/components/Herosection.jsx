    ...
    return (
        <div className="flex flex-col items-center mt-1 lg:mt-20" >
            ...
            <p className="mt-10 text-lg text-center text-neutral-500 max-w-4xl">
                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Numquam accusantium voluptatum ducimus expedita quae illum deserunt iure quia dolor, officia cum alias optio cumque non ex enim, fuga illo. Esse?
            </p>
